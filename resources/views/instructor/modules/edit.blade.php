@extends('layouts.app')
@section('title', 'Edit Module') @section('page-title', 'Edit Module')
...
<div class="card">
    <div class="card-header py-3 px-4 d-flex justify-content-between align-items-center">
        <h6 class="mb-0 fw-semibold"><i class="bi bi-pencil text-warning me-2"></i>Edit Module</h6>
    ...
    <div class="card-body p-4">
        <form action="{{ route('instructor.courses.modules.update', [$course, $module]) }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="number" name="order" class="form-control" value="{{ old('order', $module->order) }}" min="0">
            </div>
            <div class="mb-4 form-check">
                <input type="checkbox" name="is_active" class="form-check-input" id="is_active" value="1" {{ old('is_active', $module->is_active) ? 'checked' : '' }}>
                <label class="form-check-label" for="is_active">Active</label>
            </div>
            <div class="d-flex gap-2">
                <button type="submit" class="btn btn-warning px-4"><i class="bi bi-check-circle me-2"></i>Update Module</button>
