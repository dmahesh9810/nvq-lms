        ...
        <form action="{{ route('instructor.courses.modules.units.store', [$course, $module]) }}" method="POST">
            ...
            <div class="row">
                <div class="col-md-8 mb-3">
                    ...
                    <input type="text" name="nvq_unit_code" class="form-control @error('nvq_unit_code') is-invalid @enderror" value="{{ old('nvq_unit_code') }}" placeholder="e.g. EMV/IT/1/01">
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <select name="nvq_level" class="form-select @error('nvq_level') is-invalid @enderror">
                        @for($i=1; $i<=7; $i++)
                            <option value="{{ $i }}" {{ old('nvq_level', 4) == $i ? 'selected' : '' }}>Level {{ $i }}</option>
                        @endfor
                    </select>
            ...
            <div class="mb-3">
                ...
                <textarea name="learning_outcomes" rows="3" class="form-control @error('learning_outcomes') is-invalid @enderror" placeholder="List the learning outcomes...">{{ old('learning_outcomes') }}</textarea>
            ...
            <div class="mb-3">
                ...
                <textarea name="performance_criteria" rows="3" class="form-control @error('performance_criteria') is-invalid @enderror" placeholder="List the performance criteria...">{{ old('performance_criteria') }}</textarea>
            ...
            <div class="mb-4">
                ...
                <textarea name="assessment_criteria" rows="3" class="form-control @error('assessment_criteria') is-invalid @enderror" placeholder="List the assessment criteria...">{{ old('assessment_criteria') }}</textarea>
